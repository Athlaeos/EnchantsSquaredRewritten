...
public enum EntityClassificationType{
    ...
    EntityClassificationType(String... type){
    ...
    public static Set<EntityClassificationType> getMatchingClassifications(EntityType type){
        Set<EntityClassificationType> classifications = new HashSet<>();
        for (EntityClassificationType classification : values()){
    ...
    public static boolean isMatchingClassification(EntityType type, EntityClassificationType classification){
