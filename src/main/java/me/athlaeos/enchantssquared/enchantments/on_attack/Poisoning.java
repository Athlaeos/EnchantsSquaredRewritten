...
public class Poisoning extends CustomEnchant implements TriggerOnAttackEnchantment {
    ...
    public Poisoning(int id, String type) {
        super(id, type);
        this.config = ConfigManager.getInstance().getConfig("config.yml").get();
        this.chanceBase = config.getDouble("enchantment_configuration.poisoning.apply_chance");
        this.chanceLv = config.getDouble("enchantment_configuration.poisoning.apply_chance_lv");
        this.amplifierBase = config.getInt("enchantment_configuration.poisoning.amplifier");
        this.amplifierLv = config.getInt("enchantment_configuration.poisoning.amplifier_lv");
        this.durationBase = config.getInt("enchantment_configuration.poisoning.duration");
        this.durationLv = config.getInt("enchantment_configuration.poisoning.duration_lv");
        this.naturallyCompatibleWith = new HashSet<>(config.getStringList("enchantment_configuration.poisoning.compatible_with"));
        this.incompatibleVanillaEnchantments = new HashSet<>(config.getStringList("enchantment_configuration.poisoning.incompatible_vanilla_enchantments"));
        this.incompatibleCustomEnchantments = new HashSet<>(config.getStringList("enchantment_configuration.poisoning.incompatible_custom_enchantments"));
    ...
    public String getDisplayEnchantment() {
        return config.getString("enchantment_configuration.poisoning.enchant_name", getType())
                .replace(" %lv_roman%", "")
                .replace(" %lv_number%", "");
    }
    ...
    public String getDescription() {
        return config.getString("enchantment_configuration.poisoning.description");
    }

    @Override
    public boolean isEnabled() {
        return config.getBoolean("enchantment_configuration.poisoning.enabled");
    }
    ...
    public int getWeight() {
        return config.getInt("enchantment_configuration.poisoning.weight");
    }

    @Override
    public int getMaxLevel() {
        return config.getInt("enchantment_configuration.poisoning.max_level");
    }

    @Override
    public int getMaxTableLevel() {
        return config.getInt("enchantment_configuration.poisoning.max_level_table");
    }

    @Override
    public boolean isTreasure() {
        return config.getBoolean("enchantment_configuration.poisoning.is_treasure");
    }

    @Override
    public boolean isBookOnly() {
        return config.getBoolean("enchantment_configuration.poisoning.book_only");
    }

    @Override
    public boolean isTradingEnabled() {
        return config.getBoolean("enchantment_configuration.poisoning.trade_enabled");
    }

    @Override
    public int getTradingMinBasePrice() {
        return config.getInt("enchantment_configuration.poisoning.trade_cost_base_lower");
    }

    @Override
    public int getTradingMaxBasePrice() {
        return config.getInt("enchantment_configuration.poisoning.trade_cost_base_upper");
    }

    @Override
    public int getTradingMinLeveledPrice() {
        return config.getInt("enchantment_configuration.poisoning.trade_cost_lv_lower");
    }
