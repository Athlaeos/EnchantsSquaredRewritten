...
public class FireResistance extends CustomEnchant implements TriggerOnRegularIntervalsEnchantment, AttributeEnchantment {
    ...
    public static final UUID FIRE_RESISTANCE_SLOW_UUID = UUID.fromString("47b66a8b-cd9e-4445-a2b8-8bf12e4f51de");
