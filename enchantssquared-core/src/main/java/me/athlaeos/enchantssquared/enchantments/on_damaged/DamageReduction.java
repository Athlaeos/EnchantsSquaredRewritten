...
public class DamageReduction extends CustomEnchant implements TriggerOnDamagedEnchantment {
    ...
    public void onDamaged(EntityDamageEvent e, int level) {
        if (!(e.getEntity() instanceof LivingEntity) || e.getCause() == EntityDamageEvent.DamageCause.VOID) return;
