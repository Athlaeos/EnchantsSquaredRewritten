...
public class Shockwave extends CustomEnchant implements TriggerOnInteractEnchantment {
    ...
    public void onInteract(PlayerInteractEvent e, int level) {
        ...
        if (explode) {
            e.getPlayer().getWorld().spawnParticle(Particle.valueOf(MinecraftVersion.currentVersionNewerThan(MinecraftVersion.MINECRAFT_1_20_5) ? "EXPLOSION_EMITTER" : "EXPLOSION_HUGE"), origin, 0);
