...
public class Strength extends CustomEnchant implements TriggerOnRegularIntervalsEnchantment, AttributeEnchantment {
    ...
    public static final UUID STRENGTH_UUID = UUID.fromString("50795496-8f0e-4318-9f77-3e11b7e342c5");
