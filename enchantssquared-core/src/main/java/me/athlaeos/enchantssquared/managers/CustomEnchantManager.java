...
//            } else
    ...
    private void registerEnchants(){
        ...
        registerEnchant(new StreakDamage(54, "streak_damage"));
        registerEnchant(new GroundStomper(55, "ground_stomping"));
        registerEnchant(new Exploding(56, "exploding"));
        if (MinecraftVersion.currentVersionNewerThan(MinecraftVersion.MINECRAFT_1_20_5)) {
            registerEnchant(new ScaleSmall(57, "scale"));
            registerEnchant(new ScaleBig(58, "scale2"));
