...
public enum PotionEffectMappings {
    ...
    public String currentEffectName(){
        return MinecraftVersion.currentVersionNewerThan(MinecraftVersion.MINECRAFT_1_20_5) ? newEffect : oldEffect;
    }
    ...
    public PotionEffectType getPotionEffectType(){
        return MinecraftVersion.currentVersionNewerThan(MinecraftVersion.MINECRAFT_1_20_5) ? Registry.EFFECT.get(NamespacedKey.minecraft(newEffect.toLowerCase())) : PotionEffectType.getByName(oldEffect);
    }
}
